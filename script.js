...
function renderTodos() {
    ...
    // 이벤트 리스너 추가 - 이 부분이 원래 코드에서 문제였습니다
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    filterContainer.innerHTML = `
        <button class="filter-button ${currentFilter === 'all' ? 'active' : ''}" data-filter="all">전체</button>
        <button class="filter-button ${currentFilter === 'pending' ? 'active' : ''}" data-filter="pending">진행중</button>
        <button class="filter-button ${currentFilter === 'completed' ? 'active' : ''}" data-filter="completed">완료</button>
    `;
